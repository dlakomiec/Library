...
import oldBook from './imgaes/oldbook.png';
import book1 from './imgaes/book1.jpeg';
import book2 from './imgaes/book2.jpeg';
import book3 from './imgaes/book3.jpeg';
import book4 from './imgaes/book4.jpeg';
...
export const cms = {
  ...
  texts: {
    one:
      ...
      "                        's standard dummy text ever since the 1500s, when an unkn\n" +
      '                        own printer took a galley of type and scrambled it to make\n' +
      '                        a type specimen book. It has survived not only five centu\n' +
      '                        ries, but also the leap into electronic typesetting,\n' +
